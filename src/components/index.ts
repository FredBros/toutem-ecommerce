...
export { default as CartIcon } from "./ui/CartIcon";
...
export { default as NavCategories } from "./HomePage/NavCategories";
...
export { default as Cosmetic } from "./svg/Cosmetic";
export { default as Diffuser } from "./svg/Diffuser";
